    ...
    public static class EncodingExtensions
    {
        ...
        public static byte[] GetBytes(this Encoding encoding, in ReadOnlySequence<char> chars)
        {
            ...
            else
            {
                ...
                // NetWasm's CoreLib does not expose System.Diagnostics.Debug. The upstream
                // assertion only checks an internal scratch-buffer invariant; the copy and
                // pool-return operations above remain the observable contract.
                return retVal;
            }
        }
        ...
        public static string GetString(this Encoding encoding, in ReadOnlySequence<byte> bytes)
        {
            ...
            else
            {
                ...
                // The upstream Debug.Assert only verifies that all pooled segments were copied;
                // System.Diagnostics.Debug is outside the NetWasm CoreLib profile.
