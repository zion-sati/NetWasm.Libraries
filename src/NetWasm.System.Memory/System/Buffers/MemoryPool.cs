...
namespace System.Buffers
{
    ...
    {
        // Store the shared ArrayMemoryPool in a field of its derived sealed type so the JIT can
        // see the exact type when the Shared property is inlined and devirtualize calls made on it.
