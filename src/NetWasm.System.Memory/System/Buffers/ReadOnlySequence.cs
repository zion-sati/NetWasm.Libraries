...
namespace System.Buffers
{
    ...
    {
        // NetWasm.CoreLib keeps its compatibility Debug implementation internal
        // to that assembly. Keep the upstream assertion flow annotations local
        // so nullable analysis retains the same invariants without a runtime
        // dependency on CoreLib's internal type.
        ...
        public override bool Equals(object? obj) =>
            obj is ReadOnlySequence<T> other &&
            ReferenceEquals(_startObject, other._startObject) &&
            ReferenceEquals(_endObject, other._endObject) &&
            _startInteger == other._startInteger &&
            _endInteger == other._endInteger;
        ...
        public ReadOnlySequence<T> Slice(long start, SequencePosition end)
        {
            ...
            Assert(sliceEndIndex >= 0 && startIndex >= 0 && endIndex >= 0);
            if (!InRange(
                sliceRange,
                startRange,
        ...
        FoundInFirstSegment:
            ...
            Assert(start <= int.MaxValue - startIndex);
        ...
        public ReadOnlySequence<T> Slice(SequencePosition start, long length)
        {
            ...
            Assert(sliceStartIndex >= 0 && startIndex >= 0 && endIndex >= 0);
        ...
        FoundInFirstSegment:
            ...
            Assert(length <= int.MaxValue - sliceStartIndex);
        ...
        public long GetOffset(SequencePosition position)
        {
            ...
            else
            {
                ...
                Assert(positionSequenceObject != null);
                ...
                Assert(currentSegment!.RunningIndex + positionIndex >= 0);
