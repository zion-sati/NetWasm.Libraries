...
namespace System.Buffers
{
    ...
    public sealed class ReadOnlySequenceStream : Stream
    {
        ...
        public override Task<int> ReadAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken)
        {
            ...
            // The NetWasm P10 profile completes sequence reads synchronously. The upstream
            // CachedCompletedInt32Task helper is an allocation optimization, not a scheduling
            // contract, so Task.FromResult preserves the observable result without adding it.
        ...
        /// <summary>Writes a sequence of bytes to the stream. This method is not supported and always throws a <see cref="NotSupportedException"/>.</summary>
        /// <exception cref="NotSupportedException">In all cases.</exception>
        public override void Write(ReadOnlySpan<byte> buffer) => throw new NotSupportedException("Stream does not support writing.");
        ...
        /// <exception cref="NotSupportedException">In all cases.</exception>
        public override Task WriteAsync(byte[] buffer, int offset, int count, CancellationToken cancellationToken) => throw new NotSupportedException("Stream does not support writing.");

        /// <inheritdoc/>
        /// <summary>Asynchronously writes a sequence of bytes to the stream. This method is not supported and always throws a <see cref="NotSupportedException"/>.</summary>
        /// <exception cref="NotSupportedException">In all cases.</exception>
        public override ValueTask WriteAsync(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken = default) => throw new NotSupportedException("Stream does not support writing.");
        ...
        /// <exception cref="NotSupportedException">In all cases.</exception>
        public override void SetLength(long value) => throw new NotSupportedException("Stream does not support writing.");
