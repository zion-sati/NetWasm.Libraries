...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public class ServiceDescriptor
    {
            ...
            : this(serviceType, serviceKey, lifetime)
        {
            ...
            _implementationIdentity = implementationType;
        }
            ...
            : this(serviceType, serviceKey, ServiceLifetime.Singleton)
        {
            ...
            _implementationIdentity = instance.GetType();
        }
            ...
            : this(serviceType, serviceKey: null, lifetime)
        {
            ...
            _implementationIdentity = typeof(object);
        }
        ...
        private Type? _implementationIdentity;
        ...
        {
            Debug.Assert(_implementationIdentity is not null);
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeFactory<TService, TImplementation>(implementationFactory, ServiceLifetime.Transient);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeKeyedFactory<TService, TImplementation>(serviceKey, implementationFactory, ServiceLifetime.Transient);
        }
            ...
            where TService : class
        {
            ...
            return DescribeFactory<TService, TService>(implementationFactory, ServiceLifetime.Transient);
        }
            ...
            where TService : class
        {
            ...
            return DescribeKeyedFactory<TService, TService>(serviceKey, implementationFactory, ServiceLifetime.Transient);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeFactory<TService, TImplementation>(implementationFactory, ServiceLifetime.Scoped);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeKeyedFactory<TService, TImplementation>(serviceKey, implementationFactory, ServiceLifetime.Scoped);
        }
            ...
            where TService : class
        {
            ...
            return DescribeFactory<TService, TService>(implementationFactory, ServiceLifetime.Scoped);
        }
            ...
            where TService : class
        {
            ...
            return DescribeKeyedFactory<TService, TService>(serviceKey, implementationFactory, ServiceLifetime.Scoped);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeFactory<TService, TImplementation>(implementationFactory, ServiceLifetime.Singleton);
        }
            ...
            where TImplementation : class, TService
        {
            ...
            return DescribeKeyedFactory<TService, TImplementation>(serviceKey, implementationFactory, ServiceLifetime.Singleton);
        }
            ...
            where TService : class
        {
            ...
            return DescribeFactory<TService, TService>(implementationFactory, ServiceLifetime.Singleton);
        }
            ...
            where TService : class
        {
            ...
            return DescribeKeyedFactory<TService, TService>(serviceKey, implementationFactory, ServiceLifetime.Singleton);
        }
        ...
        internal static ServiceDescriptor DescribeFactory<TService, TImplementation>(
            Func<IServiceProvider, TImplementation> implementationFactory,
            ServiceLifetime lifetime)
            where TService : class
            where TImplementation : class, TService
        {
            ...
            return new ServiceDescriptor(typeof(TService), implementationFactory, lifetime)
                .SetImplementationIdentity(typeof(TImplementation));
        }

        internal static ServiceDescriptor DescribeKeyedFactory<TService, TImplementation>(
            object? serviceKey,
            Func<IServiceProvider, object?, TImplementation> implementationFactory,
            ServiceLifetime lifetime)
            where TService : class
            where TImplementation : class, TService
        {
            ...
            return new ServiceDescriptor(typeof(TService), serviceKey, implementationFactory, lifetime)
                .SetImplementationIdentity(typeof(TImplementation));
        }

        private ServiceDescriptor SetImplementationIdentity(Type implementationIdentity)
        {
            ArgumentNullException.ThrowIfNull(implementationIdentity);

            _implementationIdentity = implementationIdentity;
            return this;
        }
        ...
        {
            // Debugger-only type and delegate display is intentionally supplied by
            // generated metadata in a later DI slice; it must not trigger runtime
            // type or member inspection in a NetWasm payload.
            return $"Lifetime = {Lifetime}, generated diagnostic metadata required";
        }
