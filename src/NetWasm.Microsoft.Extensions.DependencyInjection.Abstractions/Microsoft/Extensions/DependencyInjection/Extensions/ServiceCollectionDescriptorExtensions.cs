...
namespace Microsoft.Extensions.DependencyInjection.Extensions
{
    ...
    public static partial class ServiceCollectionDescriptorExtensions
    {
            ...
            object? serviceKey)
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(service);
            TryAdd(collection, ServiceDescriptor.KeyedTransient(service, serviceKey, service));
        }
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type implementationType)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationType);
            TryAdd(collection, ServiceDescriptor.KeyedTransient(service, serviceKey, implementationType));
        }
            ...
            Func<IServiceProvider, object?, object> implementationFactory)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedTransient(service, serviceKey, implementationFactory));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedTransient<TService, TService>(serviceKey));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedTransient<TService, TImplementation>(serviceKey));
        }
            ...
            where TService : class
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedTransient(serviceKey, implementationFactory));
        }
            ...
            object? serviceKey)
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(service);
            TryAdd(collection, ServiceDescriptor.KeyedScoped(service, serviceKey, service));
        }
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type implementationType)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationType);
            TryAdd(collection, ServiceDescriptor.KeyedScoped(service, serviceKey, implementationType));
        }
            ...
            Func<IServiceProvider, object?, object> implementationFactory)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedScoped(service, serviceKey, implementationFactory));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedScoped<TService, TService>(serviceKey));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedScoped<TService, TImplementation>(serviceKey));
        }
            ...
            where TService : class
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedScoped(serviceKey, implementationFactory));
        }
            ...
            object? serviceKey)
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(service);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton(service, serviceKey, service));
        }
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type implementationType)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationType);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton(service, serviceKey, implementationType));
        }
            ...
            Func<IServiceProvider, object?, object> implementationFactory)
        {
            ...
            ArgumentNullException.ThrowIfNull(service);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton(service, serviceKey, implementationFactory));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton<TService, TService>(serviceKey));
        }
        ...
        {
            ArgumentNullException.ThrowIfNull(collection);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton<TService, TImplementation>(serviceKey));
        }
            ...
            where TService : class
        {
            ...
            TryAdd(collection, ServiceDescriptor.KeyedSingleton(serviceKey, implementationInstance));
        }
            ...
            where TService : class
        {
            ArgumentNullException.ThrowIfNull(collection);
            ArgumentNullException.ThrowIfNull(implementationFactory);
            TryAdd(collection, ServiceDescriptor.KeyedSingleton(serviceKey, implementationFactory));
        }
