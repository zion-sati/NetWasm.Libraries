...
#pragma warning restore IDE0060
                {
                    if (value.IsBmp)
                    {
                        ...
                        EncoderHexConverter.ToBytesBuffer((byte)value.Value, destination, 4);
                        EncoderHexConverter.ToBytesBuffer((byte)((uint)value.Value >> 8), destination, 2);
                        return 6;
                    }
                    else
                    {
                        ...
                        destination[0] = (byte)'\\';
                        destination[1] = (byte)'u';
                        EncoderHexConverter.ToBytesBuffer((byte)highSurrogate, destination, 4);
                        EncoderHexConverter.ToBytesBuffer((byte)((uint)highSurrogate >> 8), destination, 2);
                        destination[6] = (byte)'\\';
                        destination[7] = (byte)'u';
                        EncoderHexConverter.ToBytesBuffer((byte)lowSurrogate, destination, 10);
                        EncoderHexConverter.ToBytesBuffer((byte)((uint)lowSurrogate >> 8), destination, 8);
                        return 12;
                    }
...
#pragma warning restore IDE0060
                {
                    if (value.IsBmp)
                    {
                        ...
                        destination[0] = '\\';
                        destination[1] = 'u';
                        EncoderHexConverter.ToCharsBuffer((byte)value.Value, destination, 4);
                        EncoderHexConverter.ToCharsBuffer((byte)((uint)value.Value >> 8), destination, 2);
                        return 6;
                    }
                    else
                    {
                        ...
                        destination[0] = '\\';
                        destination[1] = 'u';
                        EncoderHexConverter.ToCharsBuffer((byte)highSurrogate, destination, 4);
                        EncoderHexConverter.ToCharsBuffer((byte)((uint)highSurrogate >> 8), destination, 2);
                        destination[6] = '\\';
                        destination[7] = 'u';
                        EncoderHexConverter.ToCharsBuffer((byte)lowSurrogate, destination, 10);
                        EncoderHexConverter.ToCharsBuffer((byte)((uint)lowSurrogate >> 8), destination, 8);
                        return 12;
                    }
