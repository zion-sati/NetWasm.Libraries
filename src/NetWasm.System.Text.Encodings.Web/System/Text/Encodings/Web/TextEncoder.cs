...
namespace System.Text.Encodings.Web
{
    ...
    public abstract class TextEncoder
    {
        ...
        private string EncodeToNewString(ReadOnlySpan<char> value, int indexOfFirstCharToEncode)
        {
            ...
            StringBuilder stringBuilder = new StringBuilder(value.Slice(0, indexOfFirstCharToEncode).ToString());
            ...
            do
            {
                char[] rentedBuffer = ArrayPool<char>.Shared.Rent(Math.Max(remainingInput.Length, minBufferBumpEachIteration));
                Span<char> destBuffer = rentedBuffer;
                ...
                stringBuilder.Append(rentedBuffer, 0, charsWrittenJustNow);
                ArrayPool<char>.Shared.Return(rentedBuffer);
        ...
        public virtual void Encode(TextWriter output, string value, int startIndex, int characterCount)
        {
            ...
            output.Write(value.Substring(startIndex, indexOfFirstCharToEncode));
        ...
        {
            throw new ArgumentException("The encoder returned an invalid output length.");
        }
    }
}
