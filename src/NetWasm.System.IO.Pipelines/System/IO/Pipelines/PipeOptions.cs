...
namespace System.IO.Pipelines
{
    ...
    public class PipeOptions
    {
            ...
            bool useSynchronizationContext = true)
        {
            ...
            // NetWasm runs a single reactor by default. Callers that need another
            // execution policy must provide an explicit scheduler.
            ReaderScheduler = readerScheduler ?? PipeScheduler.Inline;
            WriterScheduler = writerScheduler ?? PipeScheduler.Inline;
