...
public sealed class GeneratedRegexAttribute : Attribute
{
    ...
    public GeneratedRegexAttribute([StringSyntax(StringSyntaxAttribute.Regex, nameof(options))] string pattern, RegexOptions options) : this(pattern, options, -1)
    {
    }
    ...
    /// </para>
    /// </remarks>
    public GeneratedRegexAttribute([StringSyntax(StringSyntaxAttribute.Regex, nameof(options))] string pattern, RegexOptions options, string cultureName) : this(pattern, options, -1, cultureName)
    {
    }
    ...
    /// <param name="pattern">The regular expression pattern to match.</param>
    /// <param name="options">A bitwise combination of the enumeration values that modify the regular expression.</param>
    /// <param name="matchTimeoutMilliseconds">A time-out interval (milliseconds), or <c>-1</c>
    ...
    /// <summary>Gets a time-out interval (milliseconds), or <c>-1</c> to indicate that the method should not time out.</summary>
