...
namespace System.Text.RegularExpressions.Symbolic
{
    ...
    internal sealed class SymbolicRegexRunnerFactory : RegexRunnerFactory
    {
        ...
        /// <remarks>
        /// The wrapped <see cref="SymbolicRegexMatcher"/> can be shared across runner instances, but the
        /// runner itself has state (e.g. for captures and positions) and is scoped to one active scan.
        /// </remarks>
        private sealed class Runner<TSet> : RegexRunner where TSet : IComparable<TSet>, IEquatable<TSet>
        {
            ...
            /// <remarks>The matcher is stateless and may be shared by runner instances.</remarks>
            private readonly SymbolicRegexMatcher<TSet> _matcher;
            /// <summary>Runner-specific data to pass to the matching engine.</summary>
            /// <remarks>This state belongs to the runner and is reused for each scan.</remarks>
