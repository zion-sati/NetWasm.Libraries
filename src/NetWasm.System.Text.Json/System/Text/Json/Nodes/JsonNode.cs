...
namespace System.Text.Json.Nodes
{
    ...
    public abstract partial class JsonNode
    {
        ...
        internal static JsonNode? ConvertFromValue<T>(T? value, JsonNodeOptions? options = null)
        {
            ...
            // Reuse JsonValue.Create's closed primitive fast path before falling
            // back to source-generated metadata for arbitrary values.
            return JsonValue.Create(value, options);
        }
    }
}
