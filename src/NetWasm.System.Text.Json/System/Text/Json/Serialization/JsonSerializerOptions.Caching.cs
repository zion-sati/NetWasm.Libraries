...
namespace System.Text.Json
{
    public sealed partial class JsonSerializerOptions
    {
        ...
        internal sealed class CachingContext
        {
            ...
            {
                if (!_cache.TryGetValue(type, out CacheEntry? entry))
                {
                    entry = CreateCacheEntry(type, this);
                    _cache[type] = entry;
                }
        ...
        /// <summary>
        /// Defines a fixed-size cache of weak references to <see cref="CachingContext"/> that can be looked up lock-free.
        ...
        internal static class TrackedCachingContexts
        {
            ...
            public static CachingContext GetOrCreate(JsonSerializerOptions options)
            {
                ...
                CachingContext ctx = new(options, hashCode);
