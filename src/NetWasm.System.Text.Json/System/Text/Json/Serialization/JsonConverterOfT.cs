...
namespace System.Text.Json.Serialization
{
    ...
    public abstract partial class JsonConverter<T> : JsonConverter
    {
        ...
        {
            IsValueType = default(T) is not null || Nullable.GetUnderlyingType(typeof(T)) is not null;
...
#if !NETWASM
            if (!IsValueType && CanBePolymorphic)
            {
...
#nullable restore
        ...
        private JsonConverter<T>? _fallbackConverterForPropertyNameSerialization = null;
