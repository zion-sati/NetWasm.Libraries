...
namespace System.Text.Json.Serialization
{
    ...
    public abstract partial class JsonConverter
    {
        ...
        {
            // Built-in converter hierarchies explicitly opt in from their internal base
            // constructors. Custom JsonConverter<T> implementations remain external.
            IsInternalConverter = false;
