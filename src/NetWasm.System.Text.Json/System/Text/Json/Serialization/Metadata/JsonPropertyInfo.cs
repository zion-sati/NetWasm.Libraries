...
namespace System.Text.Json.Serialization.Metadata
{
    ...
    public abstract class JsonPropertyInfo
    {
        ...
        public ICustomAttributeProvider? AttributeProvider
        {
            get
            {
                Func<ICustomAttributeProvider>? attributeProviderFactory = AttributeProviderFactory;
...
#if NETWASM
                DeclaringTypeInfo?.Converter.IsValueType != true &&
#else
                this is { DeclaringType.IsValueType: false, IsIgnored: false, IsExtensionData: false } &&
#endif
                this is { IsIgnored: false, IsExtensionData: false } &&
...
#pragma warning restore SYSLIB0020
        ...
        private void DetermineEffectiveObjectCreationHandlingForProperty()
        {
            ...
            if (ObjectCreationHandling is null)
            {
                ...
                bool canPopulate =
                    ...
                    Get is not null &&
                    (!EffectiveConverter.IsValueType || Set is not null) &&
            ...
            else if (ObjectCreationHandling == JsonObjectCreationHandling.Populate)
            {
                ...
                if (EffectiveConverter.IsValueType && Set is null)
                {
            ...
            ref Utf8JsonReader reader)
        {
            ...
            {
                // The remaining supported extension-data shape is JsonObject.
                // Its built-in converter owns the property insertion semantics.
        ...
        {
#if NETWASM
            return MemberName == other.MemberName && DeclaringType == other.DeclaringType;
#else
            return MemberName == other.MemberName && DeclaringType.IsAssignableFrom(other.DeclaringType);
#endif
        }
