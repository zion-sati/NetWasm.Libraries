        ...
        private sealed class LoggerDebugView(Logger logger)
        {
            ...
            public List<LoggerProviderDebugView> Providers
            {
                get
                {
                    ...
                    for (int i = 0; i < logger.Loggers.Length; i++)
                    {
                        ...
                        string providerName = loggerInfo.ProviderAlias ?? loggerInfo.ProviderName ?? "Provider";
            ...
            public List<object?>? Scopes
            {
                get
                {
                    ...
                    if (logger.ScopeLoggers is ScopeLogger[] scopeLoggers && scopeLoggers.Length > 0)
                    {
                        scopeProvider = scopeLoggers[0].ExternalScopeProvider;
                    }
