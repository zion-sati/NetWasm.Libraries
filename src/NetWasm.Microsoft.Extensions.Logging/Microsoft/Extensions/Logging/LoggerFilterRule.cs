...
namespace Microsoft.Extensions.Logging
{
    ...
    public class LoggerFilterRule
    {
        ...
        public LoggerFilterRule(string? providerName, string? categoryName, LogLevel? logLevel, Func<string?, string?, LogLevel, bool>? filter)
            : this(providerName, categoryName, logLevel, filter, null)
        {
        }

        internal LoggerFilterRule(string? providerName, string? categoryName, LogLevel? logLevel,
            Func<string?, string?, LogLevel, bool>? filter, Func<ILoggerProvider, bool>? providerFilter)
        {
        ...
        internal Func<ILoggerProvider, bool>? ProviderFilter { get; }
