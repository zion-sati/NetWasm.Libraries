...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        private abstract class AsyncIterator<TSource> : IAsyncEnumerable<TSource>, IAsyncEnumerator<TSource>
        {
            ...
            /// </summary>
            /// <remarks>
            /// If <see cref="GetAsyncEnumerator"/> is called for the first time, the result will be
            /// this iterator. Otherwise, the result will be a shallow copy. The NetWasm profile is
            /// single-reactor, so no thread identity check is required.
            /// </remarks>
            public IAsyncEnumerator<TSource> GetAsyncEnumerator(CancellationToken cancellationToken = default)
            {
                AsyncIterator<TSource> enumerator = _state == 0 ? this : Clone();
                enumerator._state = 1;
