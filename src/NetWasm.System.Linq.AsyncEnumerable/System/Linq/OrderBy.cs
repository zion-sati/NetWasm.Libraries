...
namespace System.Linq
{
    public static partial class AsyncEnumerable
    {
        ...
        private sealed partial class OrderedIterator<TElement, TKey> : OrderedIterator<TElement>
        {
            ...
            {
                // NetWasm's deterministic ordinal text profile intentionally does not expose
                // culture-sensitive StringComparer instances. Retain Comparer<string>.Default,
                // which delegates to the profile's ordinal string comparison.
        ...
        private sealed class EnumerableSorter<TElement, TKey> : EnumerableSorter<TElement>, IComparer<int>
        {
            ...
            {
                // The NetWasm profile does not expose Type.IsValueType or Span.Sort.
                // Use the upstream fallback comparer path, which preserves stable ordering.
